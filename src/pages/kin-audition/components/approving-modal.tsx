...
export const KinApprovingModal: FunctionComponent<{
  ...
  return (
    ...
    >
      ...
      <Descriptions
        title="Kinesiologist Info"
        bordered
        size="small"
        style={{ marginTop: '20px' }}
      >
        <Descriptions.Item label="Experiences">
          {kin?.kinesiologistInfo.experiences} Years
        </Descriptions.Item>
        <Descriptions.Item label="Specialization">
          {kin?.kinesiologistInfo.specialization}
        </Descriptions.Item>
        <Descriptions.Item label="Accreditation">
          {kin?.kinesiologistInfo.accreditationBody}-
          {kin?.kinesiologistInfo.accreditationNumber}
        </Descriptions.Item>
        <Descriptions.Item label="Degree">
          {kin?.kinesiologistInfo.degree}
        </Descriptions.Item>
        <Descriptions.Item label="Offer Free Consultation">
          {kin?.kinesiologistInfo.offerFreeConsultation}
        </Descriptions.Item>
        <Descriptions.Item label="Bio">
          {kin?.kinesiologistInfo.bio}
        </Descriptions.Item>
      </Descriptions>
    </Modal>
  );
