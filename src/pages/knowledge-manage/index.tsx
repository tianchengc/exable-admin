...
export const KnowledgeManage: FunctionComponent<{}> = () => {
    ...
    return <Page title={'Kin Audition'} loading={loading}>
        <Table columns={columns} dataSource={knowledgeList!} className='resource-table' title={genTitle} pagination={false} />
        <KnowledgeModal knowledge={selectedKnowledge} onOK={onOk} onCancel={onCancel} />
    </Page>
}
