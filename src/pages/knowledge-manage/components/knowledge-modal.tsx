...
import { genKnowlegePutUrl, modifyKnowledge, newKnowledge } from '../../../network/api'
import '../style.css'
...
export const KnowledgeModal: FunctionComponent<{
    ...
    return <Modal width={'80%'} confirmLoading={confirmLoading} onCancel={props.onCancel} visible={props.knowledge !== undefined} onOk={onOK}>
        <Form form={form}
            name="video-form"
            labelCol={{ span: 8 }}
            wrapperCol={{ span: 16 }}
